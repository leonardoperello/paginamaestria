...
"text-center header textinfo" > Solicitá;
Información < /legend>
    < div;
...
"col-md-1 col-md-offset-1 text-center" > /** @class */ (function () {
    function class_10() {
    }
    return class_10;
}());
"glyphicon glyphicon-user  bigicon" > /i></span >
    /** @class */ (function () {
        function class_11() {
        }
        return class_11;
...
"	glyphicon glyphicon-envelope bigicon" > /i></span >
    /** @class */ (function () {
        function class_17() {
        }
        return class_17;
...
"glyphicon glyphicon-earphone bigicon" > /i></span >
    /** @class */ (function () {
        function class_20() {
        }
        return class_20;
...
"form-control";
required;
pattern = "[0-9]+"[(ngModel)] = "model.telefono";
name = "telefono";
telefono = "ngModel" >
    /div>
    < /div>
...
"btn btn-primary btn-lg"[disabled] = "!consulta.form.valid"(click) = "guardar()" > Quiero;
saber;
más < /button>
    < /div>
    < /div>
    ...
    < /div>
    < /div>;
//# sourceMappingURL=titulo.component.html.js.map